...
<body>
	...
	<div id="page">
				...
				<div class="row">
					...
					<div class="col-xs-8 text-right menu-1">
						<ul>
							...
							<li class="btn-cta"><a href="UserModify"><span>Sign Modify</span></a></li>
		...
		<div class="gtco-cover gtco-cover-sm" style="background-image: url(./resources/images/img_bg_1.jpg)"
