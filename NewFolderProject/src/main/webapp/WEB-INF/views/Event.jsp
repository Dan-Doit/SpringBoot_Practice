							 ...
							 <li class="has-dropdown"> <c:if test="${level eq 2}"><a href="RegStore">Management</a></c:if><c:if test="${level >2}"><a href="GetStoreInfo?request=2">Management</a></c:if>
									<ul class="dropdown">
										...
										<li><a href="GetStoreInfo?request=2" style="font-size: 14px;">Request</a></li>
											...
											<li><a href="RegCoupon" style="font-size: 14px;">Registration Coupon</a></li>
...
<div class="slideshow-container" style="justify-content: center; display: flex; align-items: center; ">
						...
						<div class="mySlides fade">
							...
							<img src="./resources/images/plus1.png"
						...
						<div class="mySlides fade">
							...
							<img src="./resources/images/plus2.png"
								style="width: 400px; height: 400px; padding-bottom: 70px;">
						...
						<div class="mySlides fade">
							...
							<img src="./resources/images/plus3.png"
								style="width: 400px; height: 400px; padding-bottom: 70px;">
