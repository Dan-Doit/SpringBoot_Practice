				...
				<div class="row">
					...
					<div class="col-xs-8 text-right menu-1">
						<ul>
							...
							<li class="btn-cta"><a href="Loginindex"><span>Sign
										in</span></a></li>
						...
						<div class="gtco-widget">
							...
							<ul class="gtco-quick-contact">
								...
								<li><a href="#"><i class="icon-mail2"></i>
										kjhg478@gmail.com</a></li>
								<li><a href="#"><i class="icon-chat"></i><span
										id="kakaoID2">Kakao</span></a></li>

							</ul>
							<ul class="gtco-quick-contact">
								<li><a href="#"><i class="icon-phone"></i>010 9495 9361 </a></li>
								<li><a href="#"><i class="icon-mail2"></i>
										jsy940221@naver.com</a></li>
								<li><a href="#"><i class="icon-chat"></i><span
							...
							<ul class="gtco-quick-contact">
								...
								kakaoid3.addEventListener("mouseover",()=>{kakaoid3.innerHTML="정소윤"});
